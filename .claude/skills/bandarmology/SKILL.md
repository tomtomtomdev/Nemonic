...
## IDX Screener — Quiet Bandar Accumulation
...
**Entry timing**: Early (Wyckoff Phase B / early C) — stealth accumulation. Higher R:R, lower hit rate. Route from `institutional-flow` universe.
