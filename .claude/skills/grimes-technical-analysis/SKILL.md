...
## IDX Screener — With-Trend Pullback (Statistical Edge)
...
**Invalidation**: Close < Price MA 50.

**Entry timing**: Mid (Wyckoff Phase D markup) — continuation re-entry. Route from `institutional-flow` universe.
