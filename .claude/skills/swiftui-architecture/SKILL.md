...
description: >
  Guidance on choosing and applying scalable SwiftUI architecture patterns — MVVM vs UDF
  (Unidirectional Data Flow) vs lightweight Clean Architecture vs TCA. Use this skill whenever
  the user mentions: SwiftUI architecture, ViewModel size, "fat ViewModel", MVVM vs UDF, TCA
  (The Composable Architecture), reducer, feature store, "scale my SwiftUI app", VIP for SwiftUI,
  navigation patterns, dependency injection in SwiftUI, @Observable vs ObservableObject for
  architectural reasons, or how to structure a SwiftUI feature. Also trigger for "where should
  this state live", "how do I split this view", or "what pattern should I use for this SwiftUI
  app".
---
