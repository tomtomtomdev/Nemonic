...
description: >
  Apply Martin Fowler's "Refactoring: Improving the Design of Existing Code" (2nd Edition)
  catalog and discipline. Use this skill whenever the user mentions: refactor, refactoring,
  simplify, code smell, Extract Function, Extract Variable, Extract Class, Inline Function/Variable,
  Move Method/Field, Replace Conditional with Polymorphism, Replace Temp with Query, Hide Delegate,
  Introduce Parameter Object, "two hats" (refactoring vs feature), behavior-preserving change,
  or Fowler. Also trigger for "clean this up", "this function is too long", "simplify this
  conditional", or "improve the design without changing behavior".
---
