...
name: legacy-code
description: >
  Apply Michael Feathers' "Working Effectively with Legacy Code" techniques when changing code
  that lacks tests. Use this skill whenever the user mentions: legacy code, untested code,
  "I can't test this", breaking dependencies, finding seams, sprout method, sprout class,
  wrap method, wrap class, characterization tests, getting code into a test harness, scratch
  refactoring, effect sketches, or Michael Feathers. Also trigger for questions like "how do I
  test this existing code", "how do I safely change this", or "where do I start with this messy
  codebase".
---
